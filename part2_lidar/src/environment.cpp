...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr &viewer,ProcessPointClouds<pcl::PointXYZI> *pointProcessor, pcl::PointCloud<pcl::PointXYZI>::Ptr &inputCloud)
{
  ...
  // ----------------------------------------------------
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters=pointProcessor->Clustering(segmentCloud.first, 0.35, 30, 1775);
    int clusterId = 0;
    ...
    //renderPointCloud(viewer,inputCloud,"filterCloud");//过滤后的pcl流
}
